...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['courses'])) {  
    ...
    // پردازش دروس انتخابی (آپدیت فیلد pass در جدول courses)  
    foreach ($selected_courses as $course_id) {  
        // کوئری برای آپدیت وضعیت درس به "پاس شده"  
        $sql = "UPDATE courses SET pass = 1 WHERE id = ?";  
        ...
        if (mysqli_stmt_execute($stmt)) {
            ...
            header("Location: consulting2.php"); 
...
<body>  
    <div class="container center-container">  
        <div class="main-text">  
            لطفا دروسی که پاس کردید را تیک بزنید  
        </div>  

        <div class="course-list">  
            <form method="post">  
                <?php  
                // کوئری برای خواندن دروس از جدول courses  
